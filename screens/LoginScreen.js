...
import { View, Text, TextInput, TouchableOpacity, StyleSheet, Alert, Image, I18nManager } from 'react-native';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.languageContainer}>
        ...
        <TouchableOpacity style={styles.languageButton} onPress={() => changeLanguage('fr')}>
          <Text style={styles.languageText}>🇫🇷 Français</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.languageButton} onPress={() => changeLanguage('ar')}>
